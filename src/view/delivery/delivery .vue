...
<template>
	...
	<div>
        ...
        <van-swipe-item v-for="(image, index) in info[0].images" :key="index">
		...
		<div class="details">
         ...
         <van-button bottom-action>马上提取现货 </van-button>
        <!-- 商品图文详情 -->
	</div>
</template>
<script>
        ...
        data(){
            return{
                info:[
                {
                    ...
                    content:'<div style="text-align: center;"><img id="1" alt="" class="" src="//img30.360buyimg.com/popWaterMark/jfs/t19498/108/2431894716/126463/a3756bf0/5af28a62Ne2cd4e4e.jpg"></div><div style="text-align: center;"><img id="1" alt="" class="" src="//img30.360buyimg.com/popWaterMark/jfs/t17137/235/2364140079/78130/40e5c8b7/5af28a62N2868c0e2.jpg"></div><div style="text-align: center;"><img id="1" alt="" class="" src="//img30.360buyimg.com/popWaterMark/jfs/t16870/196/2399540650/149936/cff24676/5af28a62N19171db6.jpg"></div><div style="text-align: center;"><img id="1" alt="" class="" src="//img30.360buyimg.com/popWaterMark/jfs/t17821/286/2384298784/181236/251627fb/5af28a62N80be9aa8.jpg"></div><div style="text-align: center;"><img id="1" alt="" class="" src="//img30.360buyimg.com/popWaterMark/jfs/t17425/113/2414234401/193633/ccf04a26/5af28a62Nda996d14.jpg"></div>',//详情
