...
<template>
  <div class="event-index">
    <van-row class="e-row" v-if="!this.$route.query.from">
      <van-col class="event-list" span="8" @click.native="goGoodListVC('礼卡',0)"><img src="../../../../assets/icon/lipin.png" width="50" height="50"> 礼券区</van-col>
      ...
      <van-col class="event-list" span="8" @click.native="goPickupVC()"><img src="../../../../assets/icon/tihuo.png" width="50" height="50">礼券提货</van-col>
    ...
    <van-row class="e-row" v-else>
      <van-col class="event-list" span="6" @click.native="goGoodListVC('礼卡',0)"><img src="../../../../assets/icon/lipin.png" width="50" height="50"> 礼券区</van-col>
