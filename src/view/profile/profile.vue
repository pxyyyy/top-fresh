    ...
    <div>
      <div class="information">
        <div class="editicon-content">
          <span class="editicon"></span>编辑资料</div>
        <!--头像-->
        <div class="userBanner">
          <img src="@/assets/img/userBanner.png" alt=""></div>
        <p>
          <img src="@/assets/img/Avatar.png" alt=""></p>
        <div class="posi">
          <!--名字及电话-->
          <van-row class="info">
            <!-- <van-col span="12"> -->
          ...
          <van-row class="info info-one">
            ...
            <van-col span="12">
              ...
              <p @click="goCoupon">代金卷</p></van-col>
          </van-row>
        </div>
      </div>
      <!--订单详情-->
        ...
        <van-cell is-link v-for="(item, index) of FeaturesList" @click="secondLevel(index)" :key="item.id">
          <template slot="title">
            <p class="user-group-list">
              <img :src="item.Url"></p>
            <p class="van-cell-text">{{item.text}}</p></template>
        </van-cell>
      </van-cell-group>
    </div>
    <!-- 继续选购 -->
