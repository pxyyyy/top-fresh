  ...
  <div>
    ...
    <div class="ladingRoll-item">
      <van-tabs v-model="active" class="ladingRoll-item-list" type="card"  @click="getLadingRollType">
        <van-tab v-for="item in ordersList" :title="item.text" class="ladingRoll-item-content">
            ...
            <div class="content-group" v-for="info in pickupVolume">
              <div class="content-top">
                ...
                <div class="content-top-info">
                  ...
                  <p class="content-top-info-date"><strong>{{info.begindate}}-{{info.enddate}}</strong></p>
                </div>
              </div>
