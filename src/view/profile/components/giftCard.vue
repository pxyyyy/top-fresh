<template>
    <div>
        <van-nav-bar title="领取礼卡" class="evetn-bar">
...
.wrappre{
    ...
    right: 0;
    bottom: 0;
    background:url(../../../assets/img/Giftcard.png) center;
    ...
    .gitcard{
        width: 300px;
        height: 100px;
        background:url(../../../assets/img/GiftcardIcon.png) center;
        background-size: cover; 
    }
    .gitcard-text{
        text-align: center;
