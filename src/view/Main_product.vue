/* * @Author: tarn.tianrun * @Date: 2018-05-14 11:08:35 * @Last Modified by: By.zhangTeng * @Last Modified time: 2018-06-08
10:55:43 */
...
<script>
	...
	export default {
		...
		mounted() {
			let from = this.$route.query.from, name = this.$route.name;
			if (from == "IOS") {
				this.isClient = true;
				this.marginTop = "15px";
